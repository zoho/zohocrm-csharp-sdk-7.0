...
namespace Com.Zoho.Crm.API.Blueprint
{
	...
	public class ProcessInfo : Model
	{
		...
		public CurrentPicklist CurrentPicklist
		{
			/// <summary>The method to get the currentPicklist</summary>
			/// <returns>Instance of CurrentPicklist</returns>
			get
			{
				return  this.currentPicklist;

			}
			/// <summary>The method to set the value to currentPicklist</summary>
			/// <param name="currentPicklist">Instance of CurrentPicklist</param>
			set
			{
				 this.currentPicklist=value;
