...
namespace Com.Zoho.Crm.API.ZiaEnrichment
{
	...
	public class ScrapyActionWrapper : Model
	{
		private ScrapyActionResponse scrapyFeedback;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public ScrapyActionResponse ScrapyFeedback
		{
			/// <summary>The method to get the scrapyFeedback</summary>
			/// <returns>Instance of ScrapyActionResponse</returns>
			get
			{
			...
			/// <param name="scrapyFeedback">Instance of ScrapyActionResponse</param>
			set
			{
