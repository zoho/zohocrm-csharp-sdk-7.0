...
namespace Com.Zoho.Crm.API.DuplicateCheckPreference
{
	...
	public class ResponseWrapper : Model, ResponseHandler
	{
		...
		public DuplicateCheckPreference DuplicateCheckPreference
		{
			/// <summary>The method to get the duplicateCheckPreference</summary>
			/// <returns>Instance of DuplicateCheckPreference</returns>
			get
			{
			...
			/// <param name="duplicateCheckPreference">Instance of DuplicateCheckPreference</param>
			set
			{
