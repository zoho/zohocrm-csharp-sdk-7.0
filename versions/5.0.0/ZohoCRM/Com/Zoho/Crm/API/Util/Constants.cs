...
namespace Com.Zoho.Crm.API.Util
{
    ...
    public static class Constants
    {
        ...
        public static readonly string CHOICE = "Com.Zoho.Crm.API.Util.Choice`1[[$type]], ZOHOCRMSDK-7.0";
        ...
        public static readonly string RECORD_TYPE = "Com.Zoho.Crm.API.Record.Record, ZOHOCRMSDK-7.0";
        ...
        public static readonly List<string> SET_CONTENT_TYPE_HEADER = new List<string> { "/crm/bulk/v7/read", "/crm/bulk/v7/write", "/crm/v7/__zia_org_enrichment", "crm/v7/__zia_people_enrichment" };
