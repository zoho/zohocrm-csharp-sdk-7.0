...
namespace Com.Zoho.Crm.API.ZiaEnrichment
{
	...
	public class ResponseWrapper : Model, ResponseHandler
	{
		...
		public List<DataEnrichment> DataEnrichment
		{
			/// <summary>The method to get the dataEnrichment</summary>
			/// <returns>Instance of List<DataEnrichment></returns>
			get
			{
			...
			/// <param name="dataEnrichment">Instance of List<DataEnrichment></param>
			set
			{
