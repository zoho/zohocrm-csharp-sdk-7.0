...
# ZOHO CRM C# SDK 7.0 for API version 7
...
2. C# SDK is available as a Nuget package. The ZOHOCRMSDK-7.0 assembly can be installed through the Nuget Package Manager or through the following options:
    ...
    - Package Manager
        ...
        ```sh
        Install-Package ZOHOCRMSDK-7.0 -Version 5.0.0
    ...
    - .NET  CLI
        ...
        ```sh
        dotnet add package ZOHOCRMSDK-7.0 --version 5.0.0
    ...
    - PackageReference
        ...
        ```sh
        <ItemGroup>
            <PackageReference Include="ZOHOCRMSDK-7.0" Version="5.0.0" />
