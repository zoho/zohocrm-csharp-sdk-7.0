...
namespace Samples.RecordLockingConfiguration
{
    ...
    {
        public static void UpdateRecordLockingConfigurations_1(String moduleName)
        {
            ...
            restrictedCustomButton.Id = 584310400485570;
        ...
        public static void Call()
        {
            try
            {
                ...
                UpdateRecordLockingConfigurations_1(moduleAPIName);
            }
            catch (Exception e)
            {
