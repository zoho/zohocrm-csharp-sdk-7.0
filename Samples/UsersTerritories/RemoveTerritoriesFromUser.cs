...
using static Com.Zoho.Crm.API.UsersTerritories.UsersTerritoriesOperations;
...
namespace Samples.UsersTerritories
{
    ...
    {
        public static void RemoveTerritoriesFromUser_1(long userId)
        {
            UsersTerritoriesOperations usersTerritoriesOperations = new UsersTerritoriesOperations(userId);
            ParameterMap paramInstance = new ParameterMap();
            paramInstance.Add(RemoveTerritoriesFromUserParam.IDS, "34770051397");
        ...
        public static void Call()
        {
            try
            {
                ...
                RemoveTerritoriesFromUser_1(userId);
            }
            catch (Exception e)
            {
