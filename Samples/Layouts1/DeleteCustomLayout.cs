...
namespace Samples.Layouts1
{
    ...
    {
        public static void DeleteCustomLayout_1(long id, String moduleAPIName)
        {
            ...
            paramInstance.Add(DeleteCustomLayoutParam.TRANSFER_TO, "3477091055");
        ...
        public static void Call()
        {
            try
            {
                ...
                DeleteCustomLayout_1(id, moduleAPIName);
            }
            catch (Exception e)
            {
