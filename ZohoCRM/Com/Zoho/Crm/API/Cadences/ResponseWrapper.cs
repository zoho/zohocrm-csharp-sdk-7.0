...
namespace Com.Zoho.Crm.API.Cadences
{
	...
	public class ResponseWrapper : Model, ResponseHandler
	{
		...
		{
			/// <summary>The method to get the cadences</summary>
			/// <returns>Instance of List<Cadences></returns>
			get
			{
				return  this.cadences;

			}
			/// <summary>The method to set the value to cadences</summary>
			/// <param name="cadences">Instance of List<Cadences></param>
			set
			{
				 this.cadences=value;
